...
namespace Drupal\medicare_options\Plugin\Block;
 ...
 * @Block(
 *   id = "custom_sort",
 *   admin_label = @Translation("Custom Sort"),
 * )
 */
class CustomSort extends BlockBase implements ContainerFactoryPluginInterface {

  const FORM_PATH = '\Drupal\medicare_options\Form\CustomSortForm';
