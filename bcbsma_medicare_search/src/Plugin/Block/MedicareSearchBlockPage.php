 ...
 *
 * @Block(
 *   id = "medicare_search_page",
 *   admin_label = @Translation("Medicare Global search Page"),
 *   category = @Translation("Custom"),
 * )
 */
class MedicareSearchBlockPage extends BlockBase implements ContainerFactoryPluginInterface {
