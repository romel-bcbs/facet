 ...
 *
 * @WebformHandler(
 *   id = "medicare_forms_api_billchange",
 *   label = @Translation("MMSS - Medicare Forms API Bill Change"),
 ...
 * )
 */
class WebformFormAPIHandlerBillChange extends WebformHandlerBase {
  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    ...
    $from_type_value['BILLING_CHANGE_MAPD'] = "BILLING_CHANGE_MAPD";
  ...
  public function postSave(WebformSubmissionInterface $webform_submission, $update = TRUE) {
    ...
    $this->processFormDataBillChange($webform_submission, $getAccessToken['response'], $logger, $this->configuration['from_type'], $this->requestStack->fromOptions(), $apiKeys);
  }
   ...
   *   Boolean.
   */
  private function processFormDataBillChange(WebformSubmission $webform_submission, array $getAccessToken, LoggerChannel $logger, string $from_type, Client $requestStack, array $apiKeys): bool {
    $body_array_returned = $this->fieldToApiDataParsingBillChange($webform_submission, $logger, $from_type);
   ...
   *   Body Composed Array.
   */
  private function fieldToApiDataParsingBillChange(WebformSubmission $webform_submission, LoggerChannel $logger, string $from_type): array {
    ...
    $medicare_field_data_mapping_AOR_MAPD_exploded = explode(PHP_EOL, $bcbsma_webform_medicare_forms_api->get('medicare_field_data_mapping_billchange'));
